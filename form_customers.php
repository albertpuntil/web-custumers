...
<html lang="en">
    ...
    <body>
	<div class="container">
		<h3><center><?php if ($operacio=="new") echo "Nova customer"; else echo "Modificar customer"; ?></center></h3>
        <br>
		<div class="row myform">
			<div class="col-md-7 col-md-offset-3">
                <div class="alert alert-info" role="alert">
				<form name="form_customers" action="mod_customer.php?operacio=<?=$operacio?>" role="form" method="post">
					<div class="form-group">
						<label class="control-label" for="id_customer">Número d'customer:</label>
						<input required type="number" name="id_customer" id="id_customer" min="1" max="10000" class="form-control" placeholder="Introdueix el número d'customer" value="<?=$row["id_customer"]?>"<?php if ($operacio=="edit") echo "readonly" ?>/>
					</div>
                    <div class="form-group">
                    ...
                    <br>
                    <div class="form-group">
					   <label class="control-label" for="tecnic">Tècnic que atén la customer:</label>
                ...
                <?php   } ?>
                    ...
                    <div class="form-group">
                        <label class="control-label" for="tipus">Tipus customer:</label>
                    ...
                    <div class="form-group">
                        <label class="control-label" for="descripcio">Descripció customer:</label>
